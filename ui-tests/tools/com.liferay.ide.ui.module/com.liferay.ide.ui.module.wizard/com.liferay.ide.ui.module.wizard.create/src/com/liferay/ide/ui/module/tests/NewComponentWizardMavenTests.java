...
public class NewComponentWizardMavenTests extends SwtbotBase {
	...
	public void createComponentOnMultipleProjects() {
		String projectName1 = project.getName() + "maven1";
		String projectName2 = project.getName() + "maven2";
		...
		Assert.assertTrue(
			viewAction.project.visibleFileTry(
				projectName1, "src/main/java", packageName, className + ".java [Component]"));
		...
		Assert.assertTrue(
			viewAction.project.visibleFileTry(
				projectName2, "src/main/java", packageName, className + ".java [Component]"));
	...
	public void createDefaultComponentOnNonPortlet() {
		String projectName = "mavenProject";
		...
		String className = "MavenprojectPortlet";
		String packageName = "mavenProject";

		Assert.assertTrue(
			viewAction.project.visibleFileTry(
				projectName, "src/main/java", packageName, className + ".java [Component]"));

...
/**
 * java client for telnet handshake reference:
...
public class GogoTelnetClient implements AutoCloseable {
	...
	public GogoTelnetClient()
		throws IOException {

		this("localhost", 11311);
	}

	public GogoTelnetClient(String host, int port)
		throws IOException {
	...
	private String _readUntilNextGogoPrompt()
		throws IOException {
	...
	private void sendCommand(int... codes)
		throws IOException {
	...
	private void _sendCommand(int... codes)
		throws IOException {

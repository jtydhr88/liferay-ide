...
if not exist %ProgramData%\Microsoft\Windows\Start Menu\Programs\"Liferay Workspace" (echo The Liferay Workspace doesn't exist.^(Successfully^)) else echo The Liferay Workspace exists.(Error)

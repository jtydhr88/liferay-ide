...
public class SnippetEditorPropertyPage extends PropertyPage {
	...
	class Proxy implements ILaunchConfigurationDialog {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.eclipse.debug.ui.ILaunchConfigurationDialog#generateName(java.lang.
		 * String)
		 */
		@Override
		 ...
		 * 
		 * @see
		 * org.eclipse.debug.ui.ILaunchConfigurationDialog#setName(java.lang.String)
		 */
		@Override
		 ...
		 * 
		 * @see
		 * org.eclipse.debug.ui.ILaunchConfigurationDialog#setActiveTab(org.eclipse.
		 * debug.ui.ILaunchConfigurationTab)
		 */
		@Override
	...
	protected Control createContents(Composite parent) {
		...
		try {
			...
			fConfig = null;
			fWorkingCopy = null;
			JDIDebugUIPlugin.statusDialog(SnippetMessages.getString("ScrapbookLauncher.Unable_to_retrieve_settings"), //$NON-NLS-1$
					e.getStatus());
		}
		...
		if (fConfig == null) {
			try {
				...
				JDIDebugUIPlugin.statusDialog(
						SnippetMessages.getString("ScrapbookLauncher.Unable_to_retrieve_settings"), e.getStatus()); //$NON-NLS-1$
			}
		}

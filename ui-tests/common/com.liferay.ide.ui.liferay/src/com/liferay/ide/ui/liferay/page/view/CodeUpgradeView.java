...
import com.liferay.ide.ui.swtbot.page.ButtonWithTooltip;
...
public class CodeUpgradeView extends View {
	...
	public ButtonWithTooltip getAutomaticallyCorrectProblemsBtn() {
		return new ButtonWithTooltip(bot, AUTOMATICALLY_CORRECT_PROBLEMS);
	}
	...
	public ButtonWithTooltip getCollapseAllBtn() {
		return new ButtonWithTooltip(bot, COLLAPSE_ALL);
	}
	...
	public ButtonWithTooltip getExpandAllBtn() {
		return new ButtonWithTooltip(bot, EXPAND_ALL);
	}

	public ButtonWithTooltip getFindBreakingChangesBtn() {
		return new ButtonWithTooltip(bot, FIND_BREAKING_CHANGES);
	}
	...
	public ButtonWithTooltip getOpenIgnoredListBtn() {
		return new ButtonWithTooltip(bot, OPEN_IGNORED_LIST);
	}

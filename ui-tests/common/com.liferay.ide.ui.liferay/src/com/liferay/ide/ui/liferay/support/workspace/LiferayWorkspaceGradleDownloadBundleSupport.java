 ...
 * @author Rui Wang
 */
public class LiferayWorkspaceGradleDownloadBundleSupport extends LiferayWorkspaceSupport {

	public LiferayWorkspaceGradleDownloadBundleSupport(SWTWorkbenchBot bot) {
		super(bot);
	}
	...
	public String getWorkspaceName() {
		return "workspace" + timestamp + "  [Stopped]";
	}

	public String getWorkspaceStartedName() {
		return "workspace" + timestamp + "  [Started]";
	}

...
public class LiferayWorkspaceServerActionProvider extends CommonActionProvider {
	...
	public void fillContextMenu(IMenuManager menu) {
		...
		ICommonActionExtensionSite actionSite2 = getActionSite();

		ICommonViewerSite viewerSite = actionSite2.getViewSite();

		if (viewerSite instanceof ICommonViewerWorkbenchSite) {
			StructuredViewer structuredViewer = actionSite2.getStructuredViewer();

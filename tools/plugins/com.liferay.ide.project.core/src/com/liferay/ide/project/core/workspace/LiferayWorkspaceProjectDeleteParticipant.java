...
public class LiferayWorkspaceProjectDeleteParticipant extends DeleteParticipant {
	...
	private static final String _ACTIONS_DELETE_FOR_WORKSPACE_PROJECT = "Delete runtime and server.";
	private static final String _DELETE_SERVER_AND_RUNTIME_FROM_WORKSPACE_PROJECT = "Liferay Workpsace Project Bundle's Runtime Cleanup";
}

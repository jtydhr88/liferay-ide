...
public class OpenJavaProjectSelectionDialogAction extends Action {
	...
	private void _createMigrateBreakingChangeVersion(Composite composite) {
		...
		Button breakingChangsVersion70 = SWTUtil.createRadioButton(buttonGroup, "7.0", null, selectedValue, 1);
		...
		breakingChangsVersion70.addSelectionListener(
			new SelectionAdapter() {
				...
				public void widgetSelected(SelectionEvent e) {
					dataModel.setBreakingChangeVersion("7.0");
				}

			});

		Button breakingChangsVersion71 = SWTUtil.createRadioButton(buttonGroup, "7.1", null, !selectedValue, 1);
		...
		breakingChangsVersion71.addSelectionListener(
			new SelectionAdapter() {
				...
				@Override
				public void widgetSelected(SelectionEvent e) {
					dataModel.setBreakingChangeVersion("7.0,7.1");
				}

			});

		if (inputIsLiferayWorkspace) {
			dataModel.setBreakingChangeVersion("7.1");

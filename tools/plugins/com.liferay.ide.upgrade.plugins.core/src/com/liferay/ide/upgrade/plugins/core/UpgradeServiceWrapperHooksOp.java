...
import com.liferay.ide.upgrade.plugins.core.internal.servicewrapper.UpgradeServiceWrapperHooksOpMethods;
 ...
 * @author Seiphon Wang
 */
public interface UpgradeServiceWrapperHooksOp extends ExecutableElement {

	public ElementType TYPE = new ElementType(UpgradeServiceWrapperHooksOp.class);

	@DelegateImplementation(UpgradeServiceWrapperHooksOpMethods.class)
	@Override

...
if exist "%ProgramFiles(x86)%"\%liferay.workspace.home.dir% rd /s "%ProgramFiles(x86)%"\%liferay.workspace.home.dir%

if exist "%ProgramFiles(x86)%"\%liferay.developer.studio.home.dir% rd /s "%ProgramFiles(x86)%"\%liferay.developer.studio.home.dir%

if exist "%ProgramFiles(x86)%"\%LiferayDeveloperStudio.dir% rd /s "%ProgramFiles(x86)%"\%LiferayDeveloperStudio.dir%

...
import com.liferay.ide.server.core.ILiferyPortalServerWatch;
...
public class PortalServerBehavior
	...
	implements ILiferayServerBehavior, ILiferyPortalServerWatch, IJavaLaunchConfigurationConstants {

	public static final String ATTR_STOP = "stop-server";

	public PortalServerBehavior() {
		_watchedProjects = Collections.synchronizedSet(new LinkedHashSet<IProject>());
	}

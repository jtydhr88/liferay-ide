...
public class ProjectWizardTests extends SWTBotBase implements ProjectWizard
{
    ...
    public void createPortletProject()
    {
        ...
        assertTrue( page2.portletNamelabel.isVisible( TEXT_ADDITIONAL_PORTLET_OPTIONS, INDEX_VALIDATION_MESSAGE1 ) );
        assertTrue( page2.displayNamelabel.isVisible( TEXT_ADDITIONAL_PORTLET_OPTIONS, INDEX_VALIDATION_MESSAGE2 ) );
    ...
    public void createPortletProjectWithoutSampleAndLaunchNewPortletWizard()
    {
        ...
        CreateLiferayPortletWizardPageObject<SWTWorkbenchBot> newPortletPage = new CreateLiferayPortletWizardPageObject<SWTWorkbenchBot>(bot, "New Liferay Portlet");

...
import com.liferay.ide.ui.liferay.support.project.UpgradeProjectSupport;
...
public class UpgradePlannerTests extends SwtbotBase {
	...
	public void testSetUpLiferayWorkspace() {
		...
		wizardAction.newUpgradePlan.prepareSourceCodeLocation(StringPool.BLANK);
	...
	@Rule
	public UpgradeProjectSupport project = new UpgradeProjectSupport(bot);
